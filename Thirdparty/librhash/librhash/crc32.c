...
/**
 * Initialize global array crcTable. The array takes 1 KiB of the program
 * size, so generating array at run-time can save a little space.
 */
...
{
  return get_crc32(crcinit, (const unsigned char*)str, strlen(str));
}
