...
void edonr224_init(edonr_ctx *ctx);
void edonr256_init(edonr_ctx *ctx);
void edonr256_update(edonr_ctx *ctx, const unsigned char* data, size_t length);
void edonr256_final(edonr_ctx *ctx, unsigned char *result);

void edonr384_init(edonr_ctx *ctx);
void edonr512_init(edonr_ctx *ctx);
void edonr512_update(edonr_ctx *ctx, const unsigned char* data, size_t length);
