...
NOTES:			Provides an interface to the MD5Checksum class. 'strFilePath' name should 
...
std::wstring MD5Checksum::GetMD5(std::wstring strFilePath)
{
...
NOTES:			Provides an interface to the MD5Checksum class. 'File' should be open in 
...
*****************************************************************************************/
std::wstring MD5Checksum::GetMD5(FILE* File)
{
...
NOTES:			Provides an interface to the MD5Checksum class. Any data that can
