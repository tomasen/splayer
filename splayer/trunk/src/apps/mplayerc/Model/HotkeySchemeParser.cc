...
#define ADDCMD(cmd) m_list.push_back(HotkeyCmd##cmd)
  ...
  ADDCMD((ID_PLAY_SEEKFORWARDMED, VK_RIGHT, FVIRTKEY|FNOINVERT, IDS_HOTKEY_SEEKFORWARDMED));
  ADDCMD((ID_PLAY_SEEKBACKWARDMED, VK_LEFT, FVIRTKEY|FNOINVERT, IDS_HOTKEY_SEEKBACKFORD));
  ...
  ADDCMD((ID_PLAY_SEEKFORWARDSMALL, 0, FVIRTKEY|FNOINVERT, IDS_HOTKEY_SEEK_FORWARD_SMALL,APPCOMMAND_MEDIA_FAST_FORWARD));
  ADDCMD((ID_PLAY_SEEKBACKWARDSMALL, 0, FVIRTKEY|FNOINVERT, IDS_HOTKEY_SEEK_BACKWARD_SMALL,APPCOMMAND_MEDIA_REWIND));
  ...
  ADDCMD((ID_VOLUME_UP, VK_UP, FVIRTKEY|FNOINVERT, IDS_HOTKEY_VOLUME_UP, APPCOMMAND_VOLUME_UP, HotkeyCmd::WUP));//APPCOMMAND_VOLUME_UP
  ADDCMD((ID_VOLUME_DOWN, VK_DOWN, FVIRTKEY|FNOINVERT, IDS_HOTKEY_VOLUME_DOWN, APPCOMMAND_VOLUME_DOWN, HotkeyCmd::WDOWN));//APPCOMMAND_VOLUME_DOWN
