...
void CPlayerToolBar::DefaultButtonManage()
{
  ...
  CONFIGBUTTON(LOGO,SPLAYER.BMP,ALIGN_TOPLEFT,CRect(14,-50,3,3),TRUE,0,FALSE,0,0,0,CRect(0,0,0,0));
...
/*
  ...
  CONFIGBUTTON(SUBSWITCH,BTN_SUB.BMP,ALIGN_TOPLEFT,CRect(-23,-50,3,3),0,ID_SUBTOOLBARBUTTON,FALSE,540,ALIGN_RIGHT,FASTBACKWORD,CRect(20,10,22,10))
  CONFIGADDALIGN(SUBSWITCH,ALIGN_LEFT,LOGO,CRect(15,10,10,10))
  CONFIGADDALIGN(SUBSWITCH,ALIGN_RIGHT,PREV,CRect(20,10,22,10))

  CONFIGBUTTON(SUBREDUCE,BTN_SUB_DELAY_REDUCE.BMP,ALIGN_TOPLEFT,CRect(-42,-50,3,3),0,ID_SUBDELAYDEC,FALSE,540,ALIGN_RIGHT,SUBSWITCH,CRect(2,3,2,3))
  
  CONFIGBUTTON(SUBINCREASE,BTN_SUB_DELAY_INCREASE.BMP,ALIGN_TOPLEFT,CRect(-10,-50,3,3),0,ID_SUBDELAYINC,FALSE,540,ALIGN_LEFT,SUBSWITCH,CRect(2,3,2,3))
...
/*
  ...
  CONFIGBUTTON(PLAYTIME,"NOBMP",ALIGN_TOPLEFT,CRect(3,-50,105,3),TRUE,0,FALSE,0,ALIGN_LEFT,SUBINCREASE,CRect(5,5,5,5))
}
/*
