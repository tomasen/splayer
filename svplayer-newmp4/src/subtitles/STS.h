...
public:
	...
	void Add(CStringW str, bool fUnicode, int start, int end, CString style = _T("SVPDefault"), CString actor = _T(""), CString effect = _T(""), CRect marginRect = CRect(0,0,0,0), int layer = 0, int readorder = -1);
