...
/* Special folders */
enum {
    kAppleExtrasFolderIcon      = FOUR_CHAR_CODE('aex\xC3'),
    ...
    kAssistantsFolderIcon       = FOUR_CHAR_CODE('ast\xC3'),
    ...
    kControlStripModulesFolderIcon = FOUR_CHAR_CODE('sdv\xC3'),
    ...
    kHelpFolderIcon             = FOUR_CHAR_CODE('\xC3hlp'),
    kInternetFolderIcon         = FOUR_CHAR_CODE('int\xC3'),
    kInternetPlugInFolderIcon   = FOUR_CHAR_CODE('\xC3net'),
    kLocalesFolderIcon          = FOUR_CHAR_CODE('\xC3loc'),
    kMacOSReadMeFolderIcon      = FOUR_CHAR_CODE('mor\xC3'),
    kPreferencesFolderIcon      = FOUR_CHAR_CODE('prf\xC3'),
    kPrinterDescriptionFolderIcon = FOUR_CHAR_CODE('ppdf'),
    kPrinterDriverFolderIcon    = FOUR_CHAR_CODE('\xC3prd'),
    ...
    kScriptingAdditionsFolderIcon = FOUR_CHAR_CODE('\xC3scr'),
    kSharedLibrariesFolderIcon  = FOUR_CHAR_CODE('\xC3lib'),
    kScriptsFolderIcon          = FOUR_CHAR_CODE('scr\xC3'),
    ...
    kTextEncodingsFolderIcon    = FOUR_CHAR_CODE('\xC3tex'),
    kAppearanceFolderIcon       = FOUR_CHAR_CODE('appr'),
    kUtilitiesFolderIcon        = FOUR_CHAR_CODE('uti\xC3'),
    ...
    kUsersFolderIcon            = FOUR_CHAR_CODE('usr\xC3')
};
