...
void CPPageAccelTbl::SetupList()
{
	for(int row = 0; row < m_list.GetItemCount(); row++)
	{
		...
		CString type = (wc.fVirt&FVIRTKEY)?_T("键"):_T("字母");
...
CString CPPageAccelTbl::MakeAccelVkeyLabel(WORD key, bool fVirtKey)
{
	...
	switch(key)
	{
	case VK_LBUTTON: str = _T("鼠标左键"); break;
	case VK_RBUTTON: str = _T("鼠标右键"); break;
	case VK_CANCEL: str = _T("Ctrl-Break"); break;
	case VK_MBUTTON: str = _T("鼠标中键"); break;
	case VK_XBUTTON1: str = _T("鼠标4键"); break;
	case VK_XBUTTON2: str = _T("鼠标5键"); break;
	case VK_BACK: str = _T("←退格键"); break;
	case VK_TAB: str = _T("Tab键"); break;
	case VK_CLEAR: str = _T("VK_CLEAR"); break;
	case VK_RETURN: str = _T("回车键"); break;
	case VK_SHIFT: str = _T("Shift"); break;
	case VK_CONTROL: str = _T("Ctrl"); break;
	case VK_MENU: str = _T("VK_MENU"); break;
	case VK_PAUSE: str = _T("暂停(Pause)键"); break;
	case VK_CAPITAL: str = _T("大写控制键"); break;
...
//	case VK_HANJA: str = _T("VK_HANJA"); break;
	...
	case VK_SPACE: str = _T("空格键"); break;
	case VK_PRIOR: str = _T("VK_PRIOR"); break;
	case VK_NEXT: str = _T("VK_NEXT"); break;
	case VK_END: str = _T("End键"); break;
	case VK_HOME: str = _T("Home键"); break;
	case VK_LEFT: str = _T("左方向键"); break;
	case VK_UP: str = _T("上方向键"); break;
	case VK_RIGHT: str = _T("右方向键"); break;
	case VK_DOWN: str = _T("下方向键"); break;
	...
	case VK_INSERT: str = _T("Ins键"); break;
	case VK_DELETE: str = _T("Del键"); break;
	case VK_HELP: str = _T("VK_HELP"); break;
	case VK_LWIN: str = _T("左Win键"); break;
	case VK_RWIN: str = _T("右Win键"); break;
	case VK_APPS: str = _T("VK_APPS"); break;
	case VK_SLEEP: str = _T("VK_SLEEP"); break;
	case VK_NUMPAD0: str = _T("小键盘0"); break;
	case VK_NUMPAD1: str = _T("小键盘1"); break;
	case VK_NUMPAD2: str = _T("小键盘2"); break;
	case VK_NUMPAD3: str = _T("小键盘3"); break;
	case VK_NUMPAD4: str = _T("小键盘4"); break;
	case VK_NUMPAD5: str = _T("小键盘5"); break;
	case VK_NUMPAD6: str = _T("小键盘6"); break;
	case VK_NUMPAD7: str = _T("小键盘7"); break;
	case VK_NUMPAD8: str = _T("小键盘8"); break;
	case VK_NUMPAD9: str = _T("小键盘9"); break;
	case VK_MULTIPLY: str = _T("小键盘*"); break;
	case VK_ADD: str = _T("小键盘+"); break;
	case VK_SEPARATOR: str = _T("小键盘回车"); break;
	case VK_SUBTRACT: str = _T("小键盘-"); break;
	case VK_DECIMAL: str = _T("小键盘."); break;
	case VK_DIVIDE: str = _T("小键盘/"); break;
...
//	case VK_OEM_NEC_EQUAL: str = _T("VK_OEM_NEC_EQUAL"); break;
	...
	case VK_LSHIFT: str = _T("左SHIFT"); break;
	case VK_RSHIFT: str = _T("右SHIFT"); break;
	case VK_LCONTROL: str = _T("左Ctrl"); break;
	case VK_RCONTROL: str = _T("右Ctrl"); break;
	...
	case VK_OEM_7: str = _T("引号键"); break;
...
CString CPPageAccelTbl::MakeAccelShortcutLabel(ACCEL& a)
{
	...
	case VK_RETURN: str = _T("回车"); break;
	case VK_SHIFT: str = _T("Shift"); break;
	case VK_CONTROL: str = _T("Ctrl"); break;
...
CString CPPageAccelTbl::MakeMouseButtonLabel(UINT mouse)
{
	...
	switch(mouse)
	{
	case wmcmd::NONE: default: ret = _T("无"); break;
	case wmcmd::LDOWN: ret = _T("左键按下"); break;
	case wmcmd::LUP: ret = _T("左键松开"); break;
	case wmcmd::LDBLCLK: ret = _T("左键双击"); break;
	case wmcmd::MDOWN: ret = _T("中键按下"); break;
	case wmcmd::MUP: ret = _T("中键松开"); break;
	case wmcmd::MDBLCLK: ret = _T("中键双击"); break;
	case wmcmd::RDOWN: ret = _T("右键按下"); break;
	case wmcmd::RUP: ret = _T("右键松开"); break;
	case wmcmd::RDBLCLK: ret = _T("右键双击"); break;
	case wmcmd::X1DOWN: ret = _T("鼠标4键按下"); break;
	case wmcmd::X1UP: ret = _T("鼠标4键松开"); break;
	case wmcmd::X1DBLCLK: ret = _T("鼠标4键双击"); break;
	case wmcmd::X2DOWN: ret = _T("鼠标5键按下"); break;
	case wmcmd::X2UP: ret = _T("鼠标5键松开"); break;
	case wmcmd::X2DBLCLK: ret = _T("鼠标5键双击"); break;
	case wmcmd::WUP: ret = _T("滚轮向上"); break;
	case wmcmd::WDOWN: ret = _T("滚轮向下"); break;
	}
	return ret;
}
...
BOOL CPPageAccelTbl::OnInitDialog()
{
	...
	m_list.InsertColumn(COL_CMD, _T("命令"), LVCFMT_LEFT, 80);
	m_list.InsertColumn(COL_MOD, _T("功能键"), LVCFMT_LEFT, 40);
	m_list.InsertColumn(COL_KEY, _T("按键"), LVCFMT_LEFT, 40);
