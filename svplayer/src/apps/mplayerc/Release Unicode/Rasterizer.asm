...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T226800[esp+8]
	push	eax
	lea	ecx, DWORD PTR $T226796[esp+16]
	mov	DWORD PTR $T226800[esp+12], 0
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T226796[esp+16]
	push	ecx
	mov	DWORD PTR $T226796[esp+20], OFFSET ??_7bad_alloc@std@@6B@
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T227256[esp+16]
	push	eax
	lea	ecx, DWORD PTR $T227248[esp+20]
	mov	DWORD PTR $T227256[esp+20], 0
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T227248[esp+20]
	push	ecx
	mov	DWORD PTR $T227248[esp+24], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN13@Allocate@2:
$LN1@Allocate@2:
...
; 922  : 			_STD _Ptr_cat(_First, _First), _STD _Range_checked_iterator_tag());
	...
	mov	BYTE PTR $T227262[esp+4], 0
	mov	eax, DWORD PTR $T227262[esp+4]
	mov	ecx, DWORD PTR __Cat$227266[esp+4]
	push	eax
	push	ecx
...
$LN5@allocate:
	...
	lea	eax, DWORD PTR $T227757[esp+16]
	push	eax
	lea	ecx, DWORD PTR $T227763[esp+20]
	mov	DWORD PTR $T227757[esp+20], 0
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T227763[esp+20]
	push	ecx
	mov	DWORD PTR $T227763[esp+24], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN12@allocate:
$LN11@allocate:
	int	3
...
; 1252 : 		_STDEXT unchecked_uninitialized_fill_n(_Ptr, _Count, _Val, this->_Alval);
	...
	mov	BYTE PTR $T227793[esp+4], 0
	mov	eax, DWORD PTR $T227793[esp+4]
	mov	ecx, DWORD PTR __Cat$227796[esp+4]
	push	eax
	push	ecx
	push	edi
	mov	ecx, esi
...
tv4580 = -56						; size = 4
tv3837 = -56						; size = 4
_ia$228466 = -56					; size = 4
_ia$228411 = -56					; size = 4
_ia$228299 = -56					; size = 4
_ia$228246 = -56					; size = 4
...
tv3589 = -48						; size = 4
tv3377 = -48						; size = 4
_ia$228497 = -48					; size = 4
_ia$228381 = -48					; size = 4
_ia$228327 = -48					; size = 4
...
; 958  : 	bbox &= CRect(0, 0, spd.w, spd.h);
	...
	xor	eax, eax
	mov	DWORD PTR $T228196[esp+112], eax
	mov	DWORD PTR $T228196[esp+116], eax
	mov	eax, DWORD PTR _spd$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR [eax+8]
	lea	eax, DWORD PTR $T228196[esp+112]
	push	eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	push	eax
	push	eax
	mov	DWORD PTR $T228196[esp+132], ecx
	mov	DWORD PTR $T228196[esp+136], edx
	call	DWORD PTR __imp__IntersectRect@12
...
; 1002 : 							pixmix(&dst[wt], color, s[wt*2]);
	...
	sub	esi, edx
	imul	edi, esi
	mov	DWORD PTR _ia$228246[esp+112], esi
	...
	imul	esi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$228246[esp+112]
	add	ebx, esi
	...
	imul	esi, DWORD PTR _ia$228246[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$228246[esp+112]
	add	esi, ebx
...
; 1020 : 							pixmix(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]));
	...
	sub	edi, edx
	imul	esi, edi
	mov	DWORD PTR _ia$228299[esp+112], edi
	...
	imul	edi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$228299[esp+112]
	add	ebx, edi
	...
	imul	edi, DWORD PTR _ia$228299[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$228299[esp+112]
...
; 1044 : 						pixmix(&dst[wt], color, s[wt*2]);
	...
	sub	esi, edx
	inc	edx
	mov	DWORD PTR _ia$228327[esp+112], esi
	mov	esi, ebx
	and	esi, -65281				; ffff00ffH
	imul	esi, DWORD PTR _ia$228327[esp+112]
	mov	edi, ecx
	and	edi, -65281				; ffff00ffH
	imul	edi, edx
	add	edi, esi
	...
	mov	esi, DWORD PTR _ia$228327[esp+112]
	imul	ebx, esi
	mov	DWORD PTR _a$228326[esp+112], edx
	...
	imul	ebx, esi
	and	edx, 16711935				; 00ff00ffH
	imul	edx, DWORD PTR _a$228326[esp+112]
	add	edx, ebx
...
; 1060 : 						pixmix(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]));
	...
	and	ebx, 65280				; 0000ff00H
	imul	ebx, esi
	mov	DWORD PTR _ia$228381[esp+112], esi
	mov	esi, ecx
	and	esi, 65280				; 0000ff00H
	imul	esi, edx
	add	ebx, esi
	...
	and	esi, 16711935				; 00ff00ffH
	imul	esi, DWORD PTR _ia$228381[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$228381[esp+112]
	and	edi, 16711680				; 00ff0000H
	add	esi, ebx
...
; 1082 : 							pixmix2(&dst[wt], color, s[wt*2], am[wt]);
	...
	sub	esi, edx
	imul	edi, esi
	mov	DWORD PTR _ia$228411[esp+112], esi
	mov	esi, DWORD PTR tv1933[esp+112]
	inc	edx
	imul	esi, edx
	add	edi, esi
	...
	imul	esi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$228411[esp+112]
	add	ebx, esi
	...
	and	esi, 16711935				; 00ff00ffH
	imul	esi, DWORD PTR _ia$228411[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$228411[esp+112]
	add	esi, ebx
...
$LL241@Draw:
	...
	movd	mm1, edx
	psubusw	mm0, mm1
	movd	DWORD PTR _r$228423[esp+112], mm0
	emms
	mov	edx, DWORD PTR _am$[esp+112]
	movzx	edx, BYTE PTR [ebx+edx]
	imul	edx, DWORD PTR tv1917[esp+112]
	imul	edx, DWORD PTR _r$228423[esp+112]
	mov	edi, DWORD PTR [eax+ebx*4]
	shr	edx, 12					; 0000000cH
	and	edx, 255				; 000000ffH
	movd	xmm0, edi
...
; 1091 : 							pixmix2(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]), am[wt]);
	...
	sub	edi, edx
	imul	esi, edi
	mov	DWORD PTR _ia$228466[esp+112], edi
	mov	edi, DWORD PTR tv1933[esp+112]
	inc	edx
	imul	edi, edx
	add	esi, edi
	...
	imul	edi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$228466[esp+112]
	add	ebx, edi
	...
	and	edi, 16711935				; 00ff00ffH
	imul	edi, DWORD PTR _ia$228466[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$228466[esp+112]
	and	esi, 16711680				; 00ff0000H
	add	edi, ebx
...
; 1116 : 						pixmix2(&dst[wt], color, s[wt*2], am[wt]);
	...
	and	ebx, 65280				; 0000ff00H
	imul	ebx, esi
	mov	DWORD PTR _ia$228497[esp+112], esi
	mov	esi, ecx
	and	esi, 65280				; 0000ff00H
	imul	esi, edx
	add	ebx, esi
	...
	and	esi, 16711935				; 00ff00ffH
	imul	esi, DWORD PTR _ia$228497[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$228497[esp+112]
	and	edi, 16711680				; 00ff0000H
	add	esi, ebx
...
; 1128 : 						pixmix2_sse2(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]), am[wt]);
	...
	movd	mm1, edx
	psubusw	mm0, mm1
	movd	DWORD PTR _r$228509[esp+112], mm0
	emms
	...
	shr	edi, 24					; 00000018H
	imul	edx, edi
	imul	edx, DWORD PTR _r$228509[esp+112]
	mov	edi, DWORD PTR [eax+ebx*4]
	movd	xmm0, edi
	shr	edx, 12					; 0000000cH
	and	edx, 255				; 000000ffH
...
; 1137 : 						pixmix2(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]), am[wt]);
	...
	sub	esi, edx
	inc	edx
	mov	DWORD PTR _ia$228552[esp+112], esi
	mov	esi, ebx
	and	esi, -65281				; ffff00ffH
	imul	esi, DWORD PTR _ia$228552[esp+112]
	mov	edi, ecx
	and	edi, -65281				; ffff00ffH
	imul	edi, edx
	add	edi, esi
	...
	mov	esi, DWORD PTR _ia$228552[esp+112]
	imul	ebx, esi
	mov	DWORD PTR _a$228551[esp+112], edx
	...
	imul	ebx, esi
	and	edx, 16711935				; 00ff00ffH
	imul	edx, DWORD PTR _a$228551[esp+112]
	add	edx, ebx
...
; 811  : 			_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$245016[esp]
	mov	BYTE PTR $T245012[esp+4], 0
	mov	eax, DWORD PTR $T245012[esp+4]
	push	eax
...
; 811  : 			_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$245046[esp]
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T245041[esp+4], 0
	mov	eax, DWORD PTR $T245041[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 1146 : 			_Ptr, this->_Alval));
	...
	mov	ecx, DWORD PTR __Cat$245137[esp]
	mov	BYTE PTR $T245134[esp+4], 0
	mov	eax, DWORD PTR $T245134[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	ecx
	push	edx
...
; 1146 : 			_Ptr, this->_Alval));
	...
	mov	ecx, DWORD PTR __Cat$245201[esp]
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T245197[esp+4], 0
	mov	eax, DWORD PTR $T245197[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	ecx
	push	edx
...
$LN28@clear:
	...
	push	edi
	push	eax
	lea	eax, DWORD PTR $T246562[esp+40]
	push	eax
	mov	ecx, esi
...
; 742  : 		tSpanBuffer::iterator itEnd = pOutline[i]->end();
	...
	mov	DWORD PTR $T246859[esp+72], eax
	cmp	DWORD PTR [esi+12], eax
...
$LN104@Rasterize:
	call	__invalid_parameter_noinfo
$LN103@Rasterize:
	cmp	ebp, DWORD PTR $T246859[esp+72]
	je	$LN24@Rasterize
...
; 205  : 	return _STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al);
	...
	mov	ecx, DWORD PTR __Cat$270977[esp]
	mov	BYTE PTR $T270974[esp+4], 0
	mov	eax, DWORD PTR $T270974[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 851  : 			_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$271076[esp]
	mov	BYTE PTR $T271073[esp+4], 0
	mov	eax, DWORD PTR $T271073[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 851  : 			_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$271188[esp]
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T271185[esp+4], 0
	mov	eax, DWORD PTR $T271185[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 1153 : 			_Ptr, this->_Alval));
	...
	mov	ecx, DWORD PTR __Cat$271325[esp]
	mov	BYTE PTR $T271322[esp+4], 0
	mov	eax, DWORD PTR $T271322[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	ecx
	push	edx
...
; 1153 : 			_Ptr, this->_Alval));
	...
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T271469[esp+4], 0
	mov	eax, DWORD PTR $T271469[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	ecx
	push	edx
...
$LN28@clear@2:
	...
	push	edi
	push	eax
	lea	eax, DWORD PTR $T271865[esp+44]
	push	eax
	push	esi
...
; 1258 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T291273[esp+96]
	mov	DWORD PTR $T291273[esp+120], 15		; 0000000fH
	mov	DWORD PTR $T291273[esp+116], 0
	mov	BYTE PTR $T291273[esp+100], 0
	call	?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::assign
	lea	eax, DWORD PTR $T291273[esp+88]
	push	eax
	lea	ecx, DWORD PTR $T291272[esp+92]
	mov	DWORD PTR __$EHRec$[esp+100], 0
	call	??0logic_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::logic_error::logic_error
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T291272[esp+92]
	push	ecx
	mov	DWORD PTR $T291272[esp+96], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN45@Xlen:
$LN44@Xlen:
	int	3
...
$LN43@insert:
	...
	mov	DWORD PTR __Tmp$291796[esp+24], esi
	mov	DWORD PTR __Tmp$291796[esp+28], edi
	test	esi, esi
...
$LN62@insert:
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	edx, DWORD PTR __Tmp$291796[esp+24]
	mov	DWORD PTR [eax+4], edi
...
; 1258 : 		_THROW(length_error, "vector<T> too long");
	...
	push	18					; 00000012H
	push	OFFSET ??_C@_0BD@OLBABOEK@vector?$DMT?$DO?5too?5long?$AA@
	lea	ecx, DWORD PTR $T291829[esp+96]
	mov	DWORD PTR $T291829[esp+120], 15		; 0000000fH
	mov	DWORD PTR $T291829[esp+116], 0
	mov	BYTE PTR $T291829[esp+100], 0
	call	?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::assign
	lea	eax, DWORD PTR $T291829[esp+88]
	push	eax
	lea	ecx, DWORD PTR $T291828[esp+92]
	mov	DWORD PTR __$EHRec$[esp+100], 0
	call	??0logic_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::logic_error::logic_error
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T291828[esp+92]
	push	ecx
	mov	DWORD PTR $T291828[esp+96], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN45@Xlen@2:
$LN44@Xlen@2:
	int	3
...
$LN41@operator@24:
	...
	push	esi
	push	eax
	lea	eax, DWORD PTR $T292173[esp+40]
	push	eax
	push	edi
	call	?erase@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@0@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::erase
...
$LN61@vector@3:
	...
	call	__invalid_parameter_noinfo
$LN78@vector@3:
	mov	edx, DWORD PTR __Cat$292600[ebp]
	mov	eax, DWORD PTR [edi+12]
	mov	BYTE PTR $T292597[ebp], 0
	mov	ecx, DWORD PTR $T292597[ebp]
	push	ecx
	push	edx
	mov	edx, DWORD PTR $T292457[ebp]
	push	esi
	call	??$_Uninit_copy@PBU?$pair@_K_K@std@@PAU12@V?$allocator@U?$pair@_K_K@std@@@2@@std@@YAPAU?$pair@_K_K@0@PBU10@0PAU10@AAV?$allocator@U?$pair@_K_K@std@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_copy<std::pair<unsigned __int64,unsigned __int64> const *,std::pair<unsigned __int64,unsigned __int64> *,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >
	add	esp, 12					; 0000000cH
	mov	DWORD PTR [edi+16], eax
...
$LN40@push_back:
	...
	push	edi
	push	eax
	lea	eax, DWORD PTR $T292637[esp+28]
	push	eax
	mov	ecx, esi
...
$LN28@reserve:
	mov	eax, DWORD PTR [edi+12]
	mov	DWORD PTR $T293318[ebp], eax
	cmp	eax, DWORD PTR [edi+16]
	jbe	SHORT $LN47@reserve
	call	__invalid_parameter_noinfo
	mov	eax, DWORD PTR $T293318[ebp]
$LN47@reserve:
	mov	edx, DWORD PTR __Cat$293521[ebp]
	mov	BYTE PTR $T293518[ebp], 0
	mov	ecx, DWORD PTR $T293518[ebp]
	push	ecx
	push	edx
	push	eax
	mov	eax, ebx
...
__$EHRec$ = -16						; size = 16
$T325540 = 8						; size = 1
__Cat$325543 = 8					; size = 1
$T325493 = 8						; size = 1
__Cat$325496 = 8					; size = 1
__Cat$325332 = 8					; size = 1
__Cat$325296 = 8					; size = 1
__Val$ = 8						; size = 4
__Where$ = 12						; size = 8
...
; 1183 : 				_Newvec);	// copy prefix
	...
	mov	ecx, DWORD PTR [esi+12]
	mov	BYTE PTR $T325293[ebp], 0
	mov	edx, DWORD PTR $T325293[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$325296[ebp]
	push	edx
...
; 1184 : 			_Ptr = _Ufill(_Ptr, _Count, _Val);	// add new stuff
	...
	mov	ecx, DWORD PTR __Cat$325332[ebp]
	mov	edx, DWORD PTR __Val$[ebp]
	mov	edi, eax
	add	esp, 12					; 0000000cH
	mov	BYTE PTR $T325329[ebp], 0
	mov	eax, DWORD PTR $T325329[ebp]
	push	eax
	push	ecx
	push	edi
	mov	ecx, 1
...
; 1185 : 			_Umove(_VEC_ITER_BASE(_Where), _Mylast, _Ptr);	// copy suffix
	...
	mov	edx, DWORD PTR [esi+16]
	add	esp, 12					; 0000000cH
	mov	BYTE PTR $T325493[ebp], 0
	mov	eax, DWORD PTR $T325493[ebp]
	mov	ecx, DWORD PTR __Cat$325496[ebp]
	push	eax
	mov	eax, DWORD PTR __Where$[ebp+4]
	push	ecx
...
; 1216 : 				_Tmp);	// insert new stuff off end
	...
	sar	edx, 4
	sub	ecx, edx
	mov	BYTE PTR $T325540[ebp], 0
	mov	edx, DWORD PTR $T325540[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$325543[ebp]
	push	edx
	push	eax
...
$LN43@insert@2:
	mov	esi, DWORD PTR [esi]
	mov	ebp, esi
	mov	DWORD PTR __Tmp$325849[esp+32], ebx
	test	esi, esi
...
; 819  : 			_Mylast = _Ufill(_Mylast, 1, _Val);
	...
	mov	BYTE PTR $T325886[esp+12], 0
	mov	eax, DWORD PTR $T325886[esp+12]
	mov	ecx, DWORD PTR __Cat$325889[esp+12]
	push	eax
	push	ecx
	push	esi
	mov	edx, ebx
...
$LN23@push_back@2:
	...
	push	eax
	push	ebx
	lea	edx, DWORD PTR $T325856[esp+28]
	push	edx
	mov	eax, edi
...
; 552  : 	tSpanBuffer::iterator itAE = temp.end();
	...
	mov	DWORD PTR $T326362[esp+200], ecx
	cmp	eax, ecx
...
; 554  : 	tSpanBuffer::iterator itBE = src.end();
	...
	mov	ebp, ebx
	mov	DWORD PTR $T326508[esp+200], eax
	cmp	DWORD PTR [esi+12], eax
...
$LN185@OverlapReg:
	call	__invalid_parameter_noinfo
$LN184@OverlapReg:
	cmp	esi, DWORD PTR $T326362[esp+200]
	je	$LL4@OverlapReg
	test	edi, edi
...
$LN198@OverlapReg:
	call	__invalid_parameter_noinfo
$LN197@OverlapReg:
	cmp	ebp, DWORD PTR $T326508[esp+200]
	je	$LL4@OverlapReg
...
$LN308@OverlapReg:
	...
	cmp	ebx, DWORD PTR $T326362[esp+200]
	je	$LN949@OverlapReg
	test	esi, esi
...
$LN387@OverlapReg:
	...
	cmp	edx, DWORD PTR $T326362[esp+200]
...
$LN473@OverlapReg:
	...
	mov	DWORD PTR $T325970[esp+200], ecx
	mov	DWORD PTR $T325970[esp+204], eax
	cmp	edi, eax
...
$LN995@OverlapReg:
	lea	eax, DWORD PTR $T325970[esp+200]
...
; 599  : 			dst.push_back(tSpan(x1, x2));	
	...
	mov	DWORD PTR $T325972[esp+200], edx
	lea	edx, DWORD PTR $T325972[esp+200]
	mov	DWORD PTR $T325972[esp+212], edi
...
; 637  : 			dst.push_back(tSpan(x1, x2));	
	...
	mov	edi, DWORD PTR _dst$[esp+196]
	push	edx
	mov	DWORD PTR $T325972[esp+208], eax
	mov	DWORD PTR $T325972[esp+212], ecx
...
$LN645@OverlapReg:
	...
	mov	eax, DWORD PTR [esi+12]
	adc	eax, DWORD PTR _offset2$[esp+204]
	mov	DWORD PTR $T325973[esp+200], ecx
	mov	DWORD PTR $T325973[esp+204], eax
	cmp	edi, eax
...
$LN998@OverlapReg:
	lea	eax, DWORD PTR $T325973[esp+200]
...
$LN701@OverlapReg:
	call	__invalid_parameter_noinfo
$LN700@OverlapReg:
	mov	edx, DWORD PTR $T326362[esp+200]
...
; 637  : 			dst.push_back(tSpan(x1, x2));	
	...
	mov	DWORD PTR $T325976[esp+200], ecx
	lea	ecx, DWORD PTR $T325976[esp+200]
	mov	DWORD PTR $T325976[esp+212], edi
	mov	edi, DWORD PTR _dst$[esp+196]
	push	ecx
	mov	DWORD PTR $T325976[esp+208], edx
	mov	DWORD PTR $T325976[esp+212], eax
	call	?push_back@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAEXABU?$pair@_K_K@2@@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::push_back
	mov	edi, DWORD PTR _itB$[esp+200]
	mov	ebx, DWORD PTR _offset1$[esp+204]
	jmp	$LN1014@OverlapReg
...
$LN902@OverlapReg:
	...
	adc	eax, DWORD PTR _offset1$[esp+204]
	mov	edi, DWORD PTR _dst$[esp+196]
	lea	ecx, DWORD PTR $T325978[esp+200]
	push	ecx
	mov	DWORD PTR $T325978[esp+204], edx
	mov	DWORD PTR $T325978[esp+208], eax
	mov	DWORD PTR $T325978[esp+212], esi
	mov	DWORD PTR $T325978[esp+216], ebx
	call	?push_back@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAEXABU?$pair@_K_K@2@@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::push_back
...
$LN56@ScanConver:
	...
	mov	eax, DWORD PTR [edi]
	mov	DWORD PTR $T328918[esp+124], eax
	cmp	ebp, DWORD PTR [edi+16]
	jbe	SHORT $LN75@ScanConver
	call	__invalid_parameter_noinfo
$LN75@ScanConver:
	mov	ecx, DWORD PTR $T328918[esp+124]
	mov	eax, DWORD PTR [edi]
	push	ebx
	push	ecx
	push	ebp
	push	eax
	lea	edx, DWORD PTR $T328921[esp+140]
	push	edx
	push	edi
	call	?erase@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@0@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::erase
...
$LN96@ScanConver:
	mov	ebp, DWORD PTR [edi+12]
	mov	eax, DWORD PTR [edi]
	mov	DWORD PTR $T329116[esp+124], eax
	cmp	ebp, DWORD PTR [edi+16]
	jbe	SHORT $LN115@ScanConver
	call	__invalid_parameter_noinfo
$LN115@ScanConver:
	mov	ecx, DWORD PTR $T329116[esp+124]
	mov	eax, DWORD PTR [edi]
	push	ebx
	push	ecx
	push	ebp
	push	eax
	lea	edx, DWORD PTR $T329119[esp+140]
	push	edx
	push	edi
	call	?erase@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@0@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::erase
...
; 503  : 		std::vector<int>::iterator itX2 = heap.end(); // begin() + heap.size();
	...
	mov	DWORD PTR $T330068[esp+124], eax
	cmp	ecx, eax
...
$LN384@ScanConver:
	call	__invalid_parameter_noinfo
$LN383@ScanConver:
	cmp	ebx, DWORD PTR $T330068[esp+124]
	je	$LN6@ScanConver
...
; 524  : 					mOutline.push_back(std::pair<__int64,__int64>((y<<32)+x1+0x4000000040000000i64, (y<<32)+x2+0x4000000040000000i64)); // G: damn Avery, this is evil! :)
	...
	mov	DWORD PTR $T328757[esp+132], eax
	mov	eax, DWORD PTR [esi+56]
	adc	edx, 1073741824				; 40000000H
	mov	DWORD PTR $T328757[esp+124], ecx
	mov	DWORD PTR $T328757[esp+128], edi
	mov	DWORD PTR $T328757[esp+136], edx
	test	eax, eax
...
$LN425@ScanConver:
	...
	mov	ecx, DWORD PTR __Cat$330369[esp+124]
	mov	BYTE PTR $T330366[esp+124], 0
	mov	eax, DWORD PTR $T330366[esp+124]
	push	eax
	push	ecx
	push	edi
	lea	edx, DWORD PTR $T328757[esp+136]
	mov	ecx, 1
	call	??$_Uninit_fill_n@PAU?$pair@_K_K@std@@IU12@V?$allocator@U?$pair@_K_K@std@@@2@@std@@YAXPAU?$pair@_K_K@0@IABU10@AAV?$allocator@U?$pair@_K_K@std@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_fill_n<std::pair<unsigned __int64,unsigned __int64> *,unsigned int,std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >
	add	esp, 12					; 0000000cH
	add	edi, 16					; 00000010H
...
$LN438@ScanConver:
	...
	push	edi
	push	eax
	lea	edx, DWORD PTR $T328757[esp+132]
	push	edx
	lea	eax, DWORD PTR $T330355[esp+136]
	push	eax
	mov	eax, ebx
	call	?insert@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@ABU?$pair@_K_K@2@@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::insert
$LN7@ScanConver:
