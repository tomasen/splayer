...
; 666  : 		bbox &= CRect(0, 0, spd.w, spd.h);
	...
	xor	eax, eax
	mov	DWORD PTR $T234290[esp+112], eax
	mov	DWORD PTR $T234290[esp+116], eax
	mov	eax, DWORD PTR _spd$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR [eax+8]
	lea	eax, DWORD PTR $T234290[esp+112]
	push	eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	push	eax
	push	eax
	mov	DWORD PTR $T234290[esp+132], ecx
	mov	DWORD PTR $T234290[esp+136], edx
	call	DWORD PTR __imp__IntersectRect@12
...
; 698  : 					pixmix_c(&dst[wt], color, src[wt*4]);
	...
	add	edi, ebx
	mov	ebx, ecx
	mov	DWORD PTR _ia$234367[esp+112], esi
	and	ebx, 16711935				; 00ff00ffH
	imul	ebx, esi
	mov	esi, edx
	...
	shr	ecx, 8
	and	ecx, 16711935				; 00ff00ffH
	imul	ecx, DWORD PTR _ia$234367[esp+112]
	mov	esi, edx
	shr	esi, 8
	and	esi, 255				; 000000ffH
	imul	esi, eax
...
; 378  : 					do {x.second = mymax(x.second, a->second);}
	...
	mov	DWORD PTR $T234590[esp+68], eax
	mov	eax, DWORD PTR [esi+12]
	cmp	ebx, eax
	ja	SHORT $LN65@OverlapReg
	jb	SHORT $LN123@OverlapReg
	cmp	ebp, DWORD PTR $T234590[esp+68]
	ja	SHORT $LN65@OverlapReg
$LN123@OverlapReg:
	mov	ebp, DWORD PTR $T234590[esp+68]
	mov	ebx, eax
$LN65@OverlapReg:
...
; 428  : 			dst.Add(x);
	...
	mov	DWORD PTR $T234630[esp+64], edx
	...
	mov	eax, edx
$LN84@OverlapReg:
	mov	edx, DWORD PTR $T234630[esp+64]
	add	eax, edx
...
; 437  : 			dst.Add(Span(b->first + o.first, b->second + o.second));
	...
	mov	esi, DWORD PTR [ebp+8]
	mov	DWORD PTR $T234522[esp+80], edx
	lea	edx, DWORD PTR [esi+1]
	mov	DWORD PTR $T234522[esp+72], eax
	mov	DWORD PTR $T234522[esp+76], ecx
...
$LN105@OverlapReg:
	...
	add	esp, 8
$LN106@OverlapReg:
	mov	ecx, DWORD PTR $T234522[esp+76]
	mov	DWORD PTR [ebp+4], eax
	mov	eax, DWORD PTR $T234522[esp+72]
$LN99@OverlapReg:
	lea	edx, DWORD PTR [esi+1]
	shl	esi, 4
	add	esi, DWORD PTR [ebp+4]
	mov	DWORD PTR [ebp+8], edx
	mov	edx, DWORD PTR $T234522[esp+80]
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T240142[esp+16]
	push	eax
	lea	ecx, DWORD PTR $T240134[esp+20]
	mov	DWORD PTR $T240142[esp+20], 0
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T240134[esp+20]
	push	ecx
	mov	DWORD PTR $T240134[esp+24], OFFSET ??_7bad_alloc@std@@6B@
...
; 40   : 		_THROW_NCEE(std::bad_alloc, NULL);
	...
	lea	eax, DWORD PTR $T240598[esp+16]
	push	eax
	lea	ecx, DWORD PTR $T240590[esp+20]
	mov	DWORD PTR $T240598[esp+20], 0
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T240590[esp+20]
	push	ecx
	mov	DWORD PTR $T240590[esp+24], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN13@Allocate@2:
$LN1@Allocate@2:
...
; 922  : 			_STD _Ptr_cat(_First, _First), _STD _Range_checked_iterator_tag());
	...
	mov	BYTE PTR $T240604[esp+4], 0
	mov	eax, DWORD PTR $T240604[esp+4]
	mov	ecx, DWORD PTR __Cat$240608[esp+4]
	push	eax
	push	ecx
...
$LN5@allocate:
	...
	lea	eax, DWORD PTR $T240791[esp+16]
	push	eax
	lea	ecx, DWORD PTR $T240793[esp+20]
	mov	DWORD PTR $T240791[esp+20], 0
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T240793[esp+20]
	push	ecx
	mov	DWORD PTR $T240793[esp+24], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN12@allocate:
$LN11@allocate:
	int	3
...
$LN5@allocate@2:
	...
	lea	eax, DWORD PTR $T241118[esp+16]
	push	eax
	lea	ecx, DWORD PTR $T241124[esp+20]
	mov	DWORD PTR $T241118[esp+20], 0
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	ecx, DWORD PTR $T241124[esp+20]
	push	ecx
	mov	DWORD PTR $T241124[esp+24], OFFSET ??_7bad_alloc@std@@6B@
	call	__CxxThrowException@8
$LN12@allocate@2:
$LN11@allocate@2:
	int	3
...
; 1252 : 		_STDEXT unchecked_uninitialized_fill_n(_Ptr, _Count, _Val, this->_Alval);
	...
	mov	BYTE PTR $T241154[esp+4], 0
	mov	eax, DWORD PTR $T241154[esp+4]
	mov	ecx, DWORD PTR __Cat$241157[esp+4]
	push	eax
	push	ecx
	push	edi
	mov	ecx, esi
...
tv4580 = -56						; size = 4
tv3837 = -56						; size = 4
_ia$241827 = -56					; size = 4
_ia$241772 = -56					; size = 4
_ia$241660 = -56					; size = 4
_ia$241607 = -56					; size = 4
...
tv3589 = -48						; size = 4
tv3377 = -48						; size = 4
_ia$241858 = -48					; size = 4
_ia$241742 = -48					; size = 4
_ia$241689 = -48					; size = 4
...
; 958  : 	bbox &= CRect(0, 0, spd.w, spd.h);
	...
	xor	eax, eax
	mov	DWORD PTR $T241557[esp+112], eax
	mov	DWORD PTR $T241557[esp+116], eax
	mov	eax, DWORD PTR _spd$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR [eax+8]
	lea	eax, DWORD PTR $T241557[esp+112]
	push	eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	push	eax
	push	eax
	mov	DWORD PTR $T241557[esp+132], ecx
	mov	DWORD PTR $T241557[esp+136], edx
	call	DWORD PTR __imp__IntersectRect@12
...
; 1002 : 							pixmix(&dst[wt], color, s[wt*2]);
	...
	sub	esi, edx
	imul	edi, esi
	mov	DWORD PTR _ia$241607[esp+112], esi
	...
	imul	esi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$241607[esp+112]
	add	ebx, esi
	...
	and	esi, 16711935				; 00ff00ffH
	imul	esi, DWORD PTR _ia$241607[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$241607[esp+112]
	add	esi, ebx
...
; 1020 : 							pixmix(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]));
	...
	sub	edi, edx
	imul	esi, edi
	mov	DWORD PTR _ia$241660[esp+112], edi
	...
	imul	edi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$241660[esp+112]
	add	ebx, edi
	...
	and	edi, 16711935				; 00ff00ffH
	imul	edi, DWORD PTR _ia$241660[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$241660[esp+112]
...
; 1044 : 						pixmix(&dst[wt], color, s[wt*2]);
	...
	sub	esi, edx
	inc	edx
	mov	DWORD PTR _ia$241689[esp+112], esi
	mov	esi, ebx
	and	esi, -65281				; ffff00ffH
	imul	esi, DWORD PTR _ia$241689[esp+112]
	mov	edi, ecx
	and	edi, -65281				; ffff00ffH
	imul	edi, edx
	add	edi, esi
	...
	mov	esi, DWORD PTR _ia$241689[esp+112]
	imul	ebx, esi
	mov	DWORD PTR _a$241688[esp+112], edx
	...
	imul	ebx, esi
	and	edx, 16711935				; 00ff00ffH
	imul	edx, DWORD PTR _a$241688[esp+112]
	add	edx, ebx
...
; 1060 : 						pixmix(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]));
	...
	and	ebx, 65280				; 0000ff00H
	imul	ebx, esi
	mov	DWORD PTR _ia$241742[esp+112], esi
	mov	esi, ecx
	and	esi, 65280				; 0000ff00H
	imul	esi, edx
	add	ebx, esi
	...
	and	esi, 16711935				; 00ff00ffH
	imul	esi, DWORD PTR _ia$241742[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$241742[esp+112]
	and	edi, 16711680				; 00ff0000H
	add	esi, ebx
...
; 1082 : 							pixmix2(&dst[wt], color, s[wt*2], am[wt]);
	...
	sub	esi, edx
	imul	edi, esi
	mov	DWORD PTR _ia$241772[esp+112], esi
	mov	esi, DWORD PTR tv1933[esp+112]
	inc	edx
	imul	esi, edx
	add	edi, esi
	...
	imul	esi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$241772[esp+112]
	add	ebx, esi
	...
	and	esi, 16711935				; 00ff00ffH
	imul	esi, DWORD PTR _ia$241772[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$241772[esp+112]
	add	esi, ebx
...
$LL241@Draw@2:
	...
	movd	mm1, edx
	psubusw	mm0, mm1
	movd	DWORD PTR _r$241784[esp+112], mm0
	emms
	mov	edx, DWORD PTR _am$[esp+112]
	movzx	edx, BYTE PTR [ebx+edx]
	imul	edx, DWORD PTR tv1917[esp+112]
	imul	edx, DWORD PTR _r$241784[esp+112]
	mov	edi, DWORD PTR [eax+ebx*4]
	shr	edx, 12					; 0000000cH
	and	edx, 255				; 000000ffH
	movd	xmm0, edi
...
; 1091 : 							pixmix2(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]), am[wt]);
	...
	sub	edi, edx
	imul	esi, edi
	mov	DWORD PTR _ia$241827[esp+112], edi
	mov	edi, DWORD PTR tv1933[esp+112]
	inc	edx
	imul	edi, edx
	add	esi, edi
	...
	imul	edi, edx
	and	ebx, -65281				; ffff00ffH
	imul	ebx, DWORD PTR _ia$241827[esp+112]
	add	ebx, edi
	...
	and	edi, 16711935				; 00ff00ffH
	imul	edi, DWORD PTR _ia$241827[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$241827[esp+112]
	and	esi, 16711680				; 00ff0000H
	add	edi, ebx
...
; 1116 : 						pixmix2(&dst[wt], color, s[wt*2], am[wt]);
	...
	and	ebx, 65280				; 0000ff00H
	imul	ebx, esi
	mov	DWORD PTR _ia$241858[esp+112], esi
	mov	esi, ecx
	and	esi, 65280				; 0000ff00H
	imul	esi, edx
	add	ebx, esi
	...
	and	esi, 16711935				; 00ff00ffH
	imul	esi, DWORD PTR _ia$241858[esp+112]
	shr	edx, 8
	and	edx, 16711680				; 00ff0000H
	imul	edx, DWORD PTR _ia$241858[esp+112]
	and	edi, 16711680				; 00ff0000H
	add	esi, ebx
...
; 1128 : 						pixmix2_sse2(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]), am[wt]);
	...
	movd	mm1, edx
	psubusw	mm0, mm1
	movd	DWORD PTR _r$241870[esp+112], mm0
	emms
	...
	shr	edi, 24					; 00000018H
	imul	edx, edi
	imul	edx, DWORD PTR _r$241870[esp+112]
	mov	edi, DWORD PTR [eax+ebx*4]
	movd	xmm0, edi
	shr	edx, 12					; 0000000cH
	and	edx, 255				; 000000ffH
...
; 1137 : 						pixmix2(&dst[wt], color, safe_subtract(src[wt*2+1], src[wt*2]), am[wt]);
	...
	sub	esi, edx
	inc	edx
	mov	DWORD PTR _ia$241913[esp+112], esi
	mov	esi, ebx
	and	esi, -65281				; ffff00ffH
	imul	esi, DWORD PTR _ia$241913[esp+112]
	mov	edi, ecx
	and	edi, -65281				; ffff00ffH
	imul	edi, edx
	add	edi, esi
	...
	mov	esi, DWORD PTR _ia$241913[esp+112]
	imul	ebx, esi
	mov	DWORD PTR _a$241912[esp+112], edx
	...
	imul	ebx, esi
	and	edx, 16711935				; 00ff00ffH
	imul	edx, DWORD PTR _a$241912[esp+112]
	add	edx, ebx
...
; 811  : 			_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$264319[esp]
	mov	BYTE PTR $T264315[esp+4], 0
	mov	eax, DWORD PTR $T264315[esp+4]
	push	eax
...
; 811  : 			_STD _Ptr_cat(_First, _Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$264349[esp]
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T264344[esp+4], 0
	mov	eax, DWORD PTR $T264344[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 1146 : 			_Ptr, this->_Alval));
	...
	mov	ecx, DWORD PTR __Cat$264440[esp]
	mov	BYTE PTR $T264437[esp+4], 0
	mov	eax, DWORD PTR $T264437[esp+4]
	push	eax
...
; 1146 : 			_Ptr, this->_Alval));
	...
	mov	ecx, DWORD PTR __Cat$264504[esp]
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T264500[esp+4], 0
	mov	eax, DWORD PTR $T264500[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	ecx
	push	edx
...
$LN28@clear:
	...
	push	edi
	push	eax
	lea	eax, DWORD PTR $T265866[esp+44]
	push	eax
...
; 742  : 		tSpanBuffer::iterator itEnd = pOutline[i]->end();
	...
	mov	DWORD PTR $T266164[esp+72], eax
	cmp	DWORD PTR [esi+12], eax
...
$LN104@Rasterize@2:
	call	__invalid_parameter_noinfo
$LN103@Rasterize@2:
	cmp	ebp, DWORD PTR $T266164[esp+72]
	je	$LN24@Rasterize@2
...
; 205  : 	return _STDEXT unchecked_uninitialized_copy(_First, _Last, _Dest, _Al);
	...
	mov	ecx, DWORD PTR __Cat$296997[esp]
	mov	BYTE PTR $T296994[esp+4], 0
	mov	eax, DWORD PTR $T296994[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 851  : 			_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$297084[esp]
	mov	BYTE PTR $T297081[esp+4], 0
	mov	eax, DWORD PTR $T297081[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 851  : 			_STD _Move_cat(_Dest), _STD _Range_checked_iterator_tag()));
	...
	mov	ecx, DWORD PTR __Cat$297196[esp]
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T297193[esp+4], 0
	mov	eax, DWORD PTR $T297193[esp+4]
	push	eax
	mov	eax, DWORD PTR __Dest$[esp+4]
	push	ecx
	push	edx
...
; 1153 : 			_Ptr, this->_Alval));
	...
	mov	ecx, DWORD PTR __Cat$297333[esp]
	mov	BYTE PTR $T297330[esp+4], 0
	mov	eax, DWORD PTR $T297330[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	ecx
	push	edx
...
; 1153 : 			_Ptr, this->_Alval));
	...
	mov	ecx, DWORD PTR __Cat$297489[esp]
	mov	edx, DWORD PTR __First$[esp+4]
	mov	BYTE PTR $T297486[esp+4], 0
	mov	eax, DWORD PTR $T297486[esp+4]
	push	eax
	mov	eax, DWORD PTR __Ptr$[esp+4]
	push	ecx
	push	edx
...
$LN28@clear@2:
	...
	push	edi
	push	eax
	lea	eax, DWORD PTR $T297874[esp+44]
	push	eax
	push	esi
...
; 1258 : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T319446[esp+92]
	mov	DWORD PTR $T319446[esp+116], 15		; 0000000fH
	mov	DWORD PTR $T319446[esp+112], 0
	mov	BYTE PTR $T319446[esp+96], 0
	call	?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::assign
	lea	eax, DWORD PTR $T319446[esp+84]
	push	eax
	lea	ecx, DWORD PTR $T319445[esp+88]
	mov	DWORD PTR __$EHRec$[esp+96], 0
	call	??0logic_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::logic_error::logic_error
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T319445[esp+88]
	push	ecx
	mov	DWORD PTR $T319445[esp+92], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN45@Xlen:
$LN44@Xlen:
	int	3
...
$LN43@insert:
	...
	mov	ebp, esi
	mov	DWORD PTR __Tmp$320598[esp+32], edi
	test	esi, esi
...
; 1258 : 		_THROW(length_error, "vector<T> too long");
	...
	push	18					; 00000012H
	push	OFFSET ??_C@_0BD@OLBABOEK@vector?$DMT?$DO?5too?5long?$AA@
	lea	ecx, DWORD PTR $T320605[esp+96]
	mov	DWORD PTR $T320605[esp+120], 15		; 0000000fH
	mov	DWORD PTR $T320605[esp+116], 0
	mov	BYTE PTR $T320605[esp+100], 0
	call	?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::assign
	lea	eax, DWORD PTR $T320605[esp+88]
	push	eax
	lea	ecx, DWORD PTR $T320604[esp+92]
	mov	DWORD PTR __$EHRec$[esp+100], 0
	call	??0logic_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::logic_error::logic_error
	push	OFFSET __TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T320604[esp+92]
	push	ecx
	mov	DWORD PTR $T320604[esp+96], OFFSET ??_7length_error@std@@6B@
	call	__CxxThrowException@8
$LN45@Xlen@2:
$LN44@Xlen@2:
	int	3
...
$LN41@operator@25:
	...
	push	esi
	push	eax
	lea	eax, DWORD PTR $T320949[esp+40]
	push	eax
	push	edi
	call	?erase@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@0@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::erase
...
$LN61@vector@3:
	...
	call	__invalid_parameter_noinfo
$LN78@vector@3:
	mov	edx, DWORD PTR __Cat$321376[ebp]
	mov	eax, DWORD PTR [edi+12]
	mov	BYTE PTR $T321373[ebp], 0
	mov	ecx, DWORD PTR $T321373[ebp]
	push	ecx
	push	edx
	mov	edx, DWORD PTR $T321233[ebp]
	push	esi
	call	??$_Uninit_copy@PBU?$pair@_K_K@std@@PAU12@V?$allocator@U?$pair@_K_K@std@@@2@@std@@YAPAU?$pair@_K_K@0@PBU10@0PAU10@AAV?$allocator@U?$pair@_K_K@std@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_copy<std::pair<unsigned __int64,unsigned __int64> const *,std::pair<unsigned __int64,unsigned __int64> *,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >
	add	esp, 12					; 0000000cH
	mov	DWORD PTR [edi+16], eax
...
$LN40@push_back:
	...
	push	eax
	push	ebx
	lea	ecx, DWORD PTR $T321413[esp+28]
	push	ecx
	mov	eax, edi
...
$LN28@reserve:
	mov	eax, DWORD PTR [edi+12]
	mov	DWORD PTR $T322095[ebp], eax
	cmp	eax, DWORD PTR [edi+16]
	jbe	SHORT $LN47@reserve
	call	__invalid_parameter_noinfo
	mov	eax, DWORD PTR $T322095[ebp]
$LN47@reserve:
	mov	edx, DWORD PTR __Cat$322297[ebp]
	mov	BYTE PTR $T322294[ebp], 0
	mov	ecx, DWORD PTR $T322294[ebp]
	push	ecx
	push	edx
	push	eax
	mov	eax, ebx
...
; 204  : 		path.MovePoints(CPoint(-minx*(1<<FONT_SCALE), -miny*(1<<FONT_SCALE)));
	...
	add	eax, eax
	add	ecx, ecx
	mov	DWORD PTR $T339828[esp+116], eax
	mov	eax, DWORD PTR _path$[esp+112]
	add	ecx, ecx
	add	esi, 7
	add	ebx, 7
	lea	edi, DWORD PTR $T339828[esp+116]
	sar	esi, 3
	sar	ebx, 3
	mov	DWORD PTR $T339828[esp+120], ecx
...
; 259  : 				if(j - (i-1) >= 4) _EvaluateBezier(pt[i-1], pt[i], pt[i+1], pt[i+2]);
	...
	mov	DWORD PTR $T339834[esp+116], eax
	mov	eax, DWORD PTR tv1697[esp+112]
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR [eax+4]
	mov	DWORD PTR $T339834[esp+120], ecx
	mov	ecx, DWORD PTR [esi]
	mov	DWORD PTR $T339835[esp+116], edx
	mov	edx, DWORD PTR [esi+4]
	mov	DWORD PTR $T339835[esp+120], eax
	mov	eax, DWORD PTR [ebx]
	mov	DWORD PTR $T339836[esp+116], ecx
	mov	ecx, DWORD PTR [ebx+4]
	mov	DWORD PTR $T339836[esp+120], edx
	lea	edx, DWORD PTR $T339834[esp+116]
	push	edx
	mov	DWORD PTR $T339837[esp+120], eax
	mov	DWORD PTR $T339837[esp+124], ecx
	lea	eax, DWORD PTR $T339835[esp+120]
	push	eax
	lea	ecx, DWORD PTR $T339836[esp+124]
	push	ecx
	lea	edx, DWORD PTR $T339837[esp+128]
	push	edx
	mov	ecx, ebp
	call	?_EvaluateBezier@Rasterizer@ssf@@AAEXABVCPoint@@000@Z ; ssf::Rasterizer::_EvaluateBezier
$LN16@ScanConver:
...
; 256  : 				if(j - (i-1) >= 2) _EvaluateLine(pt[i-1], pt[i]);
	...
	mov	ecx, DWORD PTR [ebx]
	mov	edx, DWORD PTR [ebx+4]
	mov	DWORD PTR $T339832[esp+124], esp
	sub	esp, 8
	mov	eax, esp
	mov	DWORD PTR [eax], ecx
	mov	ecx, ebp
	mov	DWORD PTR $T339833[esp+132], esp
	mov	DWORD PTR [eax+4], edx
	call	?_EvaluateLine@Rasterizer@ssf@@AAEXVCPoint@@0@Z ; ssf::Rasterizer::_EvaluateLine
$LN25@ScanConver:
...
$LN109@ScanConver:
	...
	push	eax
	push	edi
	lea	eax, DWORD PTR $T340217[esp+128]
	push	eax
...
; 298  : 			std::vector<int>::iterator itX2 = heap.end();
	...
	mov	DWORD PTR $T340595[esp+116], eax
	cmp	ecx, eax
...
$LN250@ScanConver:
	call	__invalid_parameter_noinfo
$LN249@ScanConver:
	cmp	esi, DWORD PTR $T340595[esp+116]
	je	$LN6@ScanConver
...
$LN317@ScanConver:
	...
	push	edi
	push	ecx
	lea	edx, DWORD PTR $T340950[esp+132]
	push	edx
...
__$EHRec$ = -16						; size = 16
$T356625 = 8						; size = 1
__Cat$356628 = 8					; size = 1
$T356576 = 8						; size = 1
__Cat$356579 = 8					; size = 1
__Cat$356416 = 8					; size = 1
__Cat$356383 = 8					; size = 1
__Val$ = 8						; size = 4
__Where$ = 12						; size = 8
...
; 1183 : 				_Newvec);	// copy prefix
	...
	mov	ecx, DWORD PTR [esi+12]
	mov	BYTE PTR $T356380[ebp], 0
	mov	edx, DWORD PTR $T356380[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$356383[ebp]
	push	edx
...
; 1184 : 			_Ptr = _Ufill(_Ptr, _Count, _Val);	// add new stuff
	...
	mov	ecx, DWORD PTR __Cat$356416[ebp]
	mov	edx, DWORD PTR __Val$[ebp]
	mov	edi, eax
	add	esp, 12					; 0000000cH
	mov	BYTE PTR $T356413[ebp], 0
	mov	eax, DWORD PTR $T356413[ebp]
	push	eax
	push	ecx
	push	edi
	mov	ecx, 1
...
; 1185 : 			_Umove(_VEC_ITER_BASE(_Where), _Mylast, _Ptr);	// copy suffix
	...
	mov	edx, DWORD PTR [esi+16]
	add	esp, 12					; 0000000cH
	mov	BYTE PTR $T356576[ebp], 0
	mov	eax, DWORD PTR $T356576[ebp]
	mov	ecx, DWORD PTR __Cat$356579[ebp]
	push	eax
...
; 1216 : 				_Tmp);	// insert new stuff off end
	...
	sar	edx, 4
	sub	ecx, edx
	mov	BYTE PTR $T356625[ebp], 0
	mov	edx, DWORD PTR $T356625[ebp]
	push	edx
	mov	edx, DWORD PTR __Cat$356628[ebp]
	push	edx
	push	eax
...
$LN43@insert@2:
	mov	esi, DWORD PTR [esi]
	mov	ebp, esi
	mov	DWORD PTR __Tmp$356935[esp+32], ebx
	test	esi, esi
...
; 819  : 			_Mylast = _Ufill(_Mylast, 1, _Val);
	...
	mov	BYTE PTR $T356973[esp+12], 0
	mov	eax, DWORD PTR $T356973[esp+12]
	mov	ecx, DWORD PTR __Cat$356976[esp+12]
	push	eax
	push	ecx
	push	esi
	mov	edx, ebx
...
$LN23@push_back@2:
	...
	push	eax
	push	ebx
	lea	edx, DWORD PTR $T356942[esp+28]
	push	edx
	mov	eax, edi
...
; 552  : 	tSpanBuffer::iterator itAE = temp.end();
	...
	mov	DWORD PTR $T357448[esp+200], ecx
	cmp	eax, ecx
...
; 554  : 	tSpanBuffer::iterator itBE = src.end();
	...
	mov	ebp, ebx
	mov	DWORD PTR $T357594[esp+200], eax
	cmp	DWORD PTR [esi+12], eax
...
$LN185@OverlapReg@2:
	call	__invalid_parameter_noinfo
$LN184@OverlapReg@2:
	cmp	esi, DWORD PTR $T357448[esp+200]
	je	$LL4@OverlapReg@2
	test	edi, edi
...
$LN198@OverlapReg@2:
	call	__invalid_parameter_noinfo
$LN197@OverlapReg@2:
	cmp	ebp, DWORD PTR $T357594[esp+200]
	je	$LL4@OverlapReg@2
...
$LN308@OverlapReg@2:
	...
	cmp	ebx, DWORD PTR $T357448[esp+200]
...
$LN387@OverlapReg@2:
	...
	cmp	edx, DWORD PTR $T357448[esp+200]
...
$LN473@OverlapReg@2:
	...
	mov	DWORD PTR $T357056[esp+200], ecx
	mov	DWORD PTR $T357056[esp+204], eax
	cmp	edi, eax
...
$LN995@OverlapReg@2:
	lea	eax, DWORD PTR $T357056[esp+200]
...
; 599  : 			dst.push_back(tSpan(x1, x2));	
	...
	mov	DWORD PTR $T357058[esp+200], edx
	lea	edx, DWORD PTR $T357058[esp+200]
	mov	DWORD PTR $T357058[esp+212], edi
...
; 637  : 			dst.push_back(tSpan(x1, x2));	
	...
	mov	edi, DWORD PTR _dst$[esp+196]
	push	edx
	mov	DWORD PTR $T357058[esp+208], eax
	mov	DWORD PTR $T357058[esp+212], ecx
...
$LN645@OverlapReg@2:
	...
	mov	eax, DWORD PTR [esi+12]
	adc	eax, DWORD PTR _offset2$[esp+204]
	mov	DWORD PTR $T357059[esp+200], ecx
	mov	DWORD PTR $T357059[esp+204], eax
	cmp	edi, eax
...
$LN998@OverlapReg@2:
	lea	eax, DWORD PTR $T357059[esp+200]
...
$LN701@OverlapReg@2:
	call	__invalid_parameter_noinfo
$LN700@OverlapReg@2:
	mov	edx, DWORD PTR $T357448[esp+200]
...
; 637  : 			dst.push_back(tSpan(x1, x2));	
	...
	mov	DWORD PTR $T357062[esp+200], ecx
	lea	ecx, DWORD PTR $T357062[esp+200]
	mov	DWORD PTR $T357062[esp+212], edi
	mov	edi, DWORD PTR _dst$[esp+196]
	push	ecx
	mov	DWORD PTR $T357062[esp+208], edx
	mov	DWORD PTR $T357062[esp+212], eax
	call	?push_back@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAEXABU?$pair@_K_K@2@@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::push_back
	mov	edi, DWORD PTR _itB$[esp+200]
	mov	ebx, DWORD PTR _offset1$[esp+204]
	jmp	$LN1014@OverlapReg@2
...
$LN902@OverlapReg@2:
	...
	adc	eax, DWORD PTR _offset1$[esp+204]
	mov	edi, DWORD PTR _dst$[esp+196]
	lea	ecx, DWORD PTR $T357064[esp+200]
	push	ecx
	mov	DWORD PTR $T357064[esp+204], edx
	mov	DWORD PTR $T357064[esp+208], eax
	mov	DWORD PTR $T357064[esp+212], esi
	mov	DWORD PTR $T357064[esp+216], ebx
	call	?push_back@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAEXABU?$pair@_K_K@2@@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::push_back
...
$LN56@ScanConver@2:
	mov	ebp, DWORD PTR [esi+12]
	mov	eax, DWORD PTR [esi]
	mov	DWORD PTR $T360004[esp+140], eax
	cmp	ebp, DWORD PTR [esi+16]
	jbe	SHORT $LN75@ScanConver@2
	call	__invalid_parameter_noinfo
$LN75@ScanConver@2:
	mov	ecx, DWORD PTR $T360004[esp+140]
	mov	eax, DWORD PTR [esi]
	push	ebx
	push	ecx
	push	ebp
	push	eax
	lea	edx, DWORD PTR $T360007[esp+156]
	push	edx
	push	esi
	call	?erase@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@0@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::erase
...
$LN96@ScanConver@2:
	mov	ebp, DWORD PTR [esi+12]
	mov	eax, DWORD PTR [esi]
	mov	DWORD PTR $T360202[esp+140], eax
	cmp	ebp, DWORD PTR [esi+16]
	jbe	SHORT $LN115@ScanConver@2
	call	__invalid_parameter_noinfo
$LN115@ScanConver@2:
	mov	ecx, DWORD PTR $T360202[esp+140]
	mov	eax, DWORD PTR [esi]
	push	ebx
	push	ecx
	push	ebp
	push	eax
	lea	edx, DWORD PTR $T360205[esp+156]
	push	edx
	push	esi
	call	?erase@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@0@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::erase
...
$LN243@ScanConver@2:
	...
	push	eax
	push	ebp
	lea	edx, DWORD PTR $T360787[esp+152]
	push	edx
...
; 503  : 		std::vector<int>::iterator itX2 = heap.end(); // begin() + heap.size();
	...
	mov	DWORD PTR $T361219[esp+140], eax
	cmp	ecx, eax
...
$LN384@ScanConver@2:
	call	__invalid_parameter_noinfo
$LN383@ScanConver@2:
	cmp	ebx, DWORD PTR $T361219[esp+140]
	je	$LN6@ScanConver@2
...
; 524  : 					mOutline.push_back(std::pair<__int64,__int64>((y<<32)+x1+0x4000000040000000i64, (y<<32)+x2+0x4000000040000000i64)); // G: damn Avery, this is evil! :)
	...
	mov	DWORD PTR $T359843[esp+148], eax
	mov	eax, DWORD PTR [edi+56]
	adc	edx, 1073741824				; 40000000H
	mov	DWORD PTR $T359843[esp+140], ecx
	mov	DWORD PTR $T359843[esp+144], esi
	mov	DWORD PTR $T359843[esp+152], edx
	test	eax, eax
...
$LN425@ScanConver@2:
	...
	mov	ecx, DWORD PTR __Cat$361542[esp+140]
	mov	BYTE PTR $T361539[esp+140], 0
	mov	eax, DWORD PTR $T361539[esp+140]
	push	eax
	push	ecx
	push	esi
	lea	edx, DWORD PTR $T359843[esp+152]
	mov	ecx, 1
	call	??$_Uninit_fill_n@PAU?$pair@_K_K@std@@IU12@V?$allocator@U?$pair@_K_K@std@@@2@@std@@YAXPAU?$pair@_K_K@0@IABU10@AAV?$allocator@U?$pair@_K_K@std@@@0@U_Nonscalar_ptr_iterator_tag@0@U_Range_checked_iterator_tag@0@@Z ; std::_Uninit_fill_n<std::pair<unsigned __int64,unsigned __int64> *,unsigned int,std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >
	add	esp, 12					; 0000000cH
	add	esi, 16					; 00000010H
...
$LN438@ScanConver@2:
	...
	push	esi
	push	eax
	lea	edx, DWORD PTR $T359843[esp+148]
	push	edx
	lea	eax, DWORD PTR $T361528[esp+152]
	push	eax
	mov	eax, ebx
	call	?insert@?$vector@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@std@@QAE?AV?$_Vector_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@V?$_Vector_const_iterator@U?$pair@_K_K@std@@V?$allocator@U?$pair@_K_K@std@@@2@@2@ABU?$pair@_K_K@2@@Z ; std::vector<std::pair<unsigned __int64,unsigned __int64>,std::allocator<std::pair<unsigned __int64,unsigned __int64> > >::insert
$LN7@ScanConver@2:
...
$LN478@ScanConver@2:
	...
	push	ebx
	push	edx
	lea	eax, DWORD PTR $T361702[esp+156]
	push	eax
