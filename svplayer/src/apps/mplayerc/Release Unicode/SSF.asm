...
; 180  : 			const RenderedSubtitle* rs = m_renderer->Lookup(s, CSize(spd.w, spd.h), spd.vidrect);
	...
	push	eax
	lea	ecx, DWORD PTR $T247895[esp+124]
	push	ecx
	...
	mov	DWORD PTR $T247896[esp+120], edx
	lea	edx, DWORD PTR $T247895[esp+120]
	mov	DWORD PTR $T247896[esp+124], eax
	push	edx
	lea	eax, DWORD PTR $T247896[esp+124]
	push	eax
	push	ebx
...
; 181  : 			if(rs) bbox2 |= rs->Draw(spd);
	...
	push	esi
	lea	ecx, DWORD PTR $T247897[esp+124]
	push	ecx
	mov	ecx, eax
...
; 184  : 		bbox = bbox2 & CRect(0, 0, spd.w, spd.h);
	...
	lea	eax, DWORD PTR $T247898[esp+120]
	mov	DWORD PTR $T247898[esp+128], ecx
	push	eax
	lea	ecx, DWORD PTR _bbox2$[esp+124]
	mov	DWORD PTR $T247898[esp+136], edx
	push	ecx
	lea	edx, DWORD PTR $T247899[esp+128]
	push	edx
	mov	DWORD PTR $T247898[esp+132], ebx
	mov	DWORD PTR $T247898[esp+136], ebx
	call	DWORD PTR __imp__IntersectRect@12
	mov	eax, DWORD PTR _bbox$[ebp]
	mov	ecx, DWORD PTR $T247899[esp+120]
	mov	edx, DWORD PTR $T247899[esp+124]
	mov	DWORD PTR [eax], ecx
	mov	ecx, DWORD PTR $T247899[esp+128]
	mov	DWORD PTR [eax+4], edx
	mov	edx, DWORD PTR $T247899[esp+132]
	mov	DWORD PTR [eax+8], ecx
...
; 104  : 			m_file->Append(ssf::WCharInputStream(str), (float)rtStart / 10000000, (float)rtStop / 10000000);
	...
	mov	BYTE PTR __$EHRec$[ebp+12], 2
	mov	eax, DWORD PTR $T332214[ebp+40]
	add	eax, -16				; fffffff0H
	lea	ecx, DWORD PTR [eax+12]
	or	edx, -1
	lock	 xadd	 DWORD PTR [ecx], edx
...
; 237  : 		return !m_fn.IsEmpty() && Open(m_fn, m_name) ? S_OK : E_FAIL;
	...
	push	ecx
	sub	eax, 16					; 00000010H
	mov	DWORD PTR $T370316[esp+40], esp
	mov	edi, esp
	push	eax
	call	?CloneData@?$CSimpleStringT@_W$0A@@ATL@@CAPAUCStringData@2@PAU32@@Z ; ATL::CSimpleStringT<wchar_t,0>::CloneData
	add	eax, 16					; 00000010H
	...
	mov	eax, DWORD PTR [esi+4]
	sub	eax, 16					; 00000010H
	mov	DWORD PTR $T370317[esp+44], esp
	mov	edi, esp
	push	eax
	call	?CloneData@?$CSimpleStringT@_W$0A@@ATL@@CAPAUCStringData@2@PAU32@@Z ; ATL::CSimpleStringT<wchar_t,0>::CloneData
	add	eax, 16					; 00000010H
