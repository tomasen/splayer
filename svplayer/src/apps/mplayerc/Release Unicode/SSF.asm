...
; 104  : 			m_file->Append(ssf::WCharInputStream(str), (float)rtStart / 10000000, (float)rtStop / 10000000);
	...
	mov	eax, DWORD PTR $T452403[ebp+40]
	add	eax, -16				; fffffff0H
	lea	ecx, DWORD PTR [eax+12]
	or	edx, -1
	lock	 xadd	 DWORD PTR [ecx], edx
	...
	call	eax
$LN29@Append@4:
	lea	ecx, DWORD PTR $T452403[ebp+16]
	mov	DWORD PTR $T452403[ebp], OFFSET ??_7InputStream@ssf@@6B@
	call	?RemoveAll@?$CAtlList@HV?$CElementTraits@H@ATL@@@ATL@@QAEXXZ ; ATL::CAtlList<int,ATL::CElementTraits<int> >::RemoveAll
$LN10@Append@4:
...
; 61   : 			if(Open(FileInputStream(fn), name)) 
	...
	mov	BYTE PTR __$EHRec$[ebp+12], 6
	mov	bl, al
	mov	eax, DWORD PTR $T452660[ebp+40]
	mov	DWORD PTR $T452660[ebp], OFFSET ??_7FileInputStream@ssf@@6B@
	test	eax, eax
	je	SHORT $LN128@Open@2
	push	eax
	call	_fclose
	add	esp, 4
	mov	DWORD PTR $T452660[ebp+40], 0
$LN128@Open@2:
	lea	ecx, DWORD PTR $T452660[ebp+16]
	mov	DWORD PTR $T452660[ebp], OFFSET ??_7InputStream@ssf@@6B@
	call	?RemoveAll@?$CAtlList@HV?$CElementTraits@H@ATL@@@ATL@@QAEXXZ ; ATL::CAtlList<int,ATL::CElementTraits<int> >::RemoveAll
	test	bl, bl
	je	SHORT $LN1@Open@2
...
; 237  : 		return !m_fn.IsEmpty() && Open(m_fn, m_name) ? S_OK : E_FAIL;
	...
	push	ecx
	sub	eax, 16					; 00000010H
	mov	DWORD PTR $T461549[esp+40], esp
	mov	edi, esp
	push	eax
	call	?CloneData@?$CSimpleStringT@_W$0A@@ATL@@CAPAUCStringData@2@PAU32@@Z ; ATL::CSimpleStringT<wchar_t,0>::CloneData
	add	eax, 16					; 00000010H
	...
	mov	eax, DWORD PTR [esi+4]
	sub	eax, 16					; 00000010H
	mov	DWORD PTR $T461550[esp+44], esp
	mov	edi, esp
	push	eax
	call	?CloneData@?$CSimpleStringT@_W$0A@@ATL@@CAPAUCStringData@2@PAU32@@Z ; ATL::CSimpleStringT<wchar_t,0>::CloneData
	add	eax, 16					; 00000010H
...
; 180  : 			const RenderedSubtitle* rs = m_renderer->Lookup(s, CSize(spd.w, spd.h), spd.vidrect);
	...
	push	ecx
	lea	edx, DWORD PTR $T461674[esp+124]
	push	edx
	call	DWORD PTR __imp__CopyRect@8
	mov	ecx, DWORD PTR [esi+8]
	mov	eax, DWORD PTR [esi+4]
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T461675[esp+124], ecx
	lea	ecx, DWORD PTR $T461674[esp+120]
	push	ecx
	mov	DWORD PTR $T461675[esp+124], eax
	mov	eax, DWORD PTR [edx+24]
	push	ebx
	push	eax
	lea	ecx, DWORD PTR $T461675[esp+132]
...
; 181  : 			if(rs) bbox2 |= rs->Draw(spd);
	...
	push	esi
	lea	edx, DWORD PTR $T461676[esp+124]
	push	edx
	push	eax
...
; 184  : 		bbox = bbox2 & CRect(0, 0, spd.w, spd.h);
	...
	xor	eax, eax
	mov	DWORD PTR $T461677[esp+120], eax
	mov	DWORD PTR $T461677[esp+124], eax
	mov	eax, DWORD PTR [esi+8]
	lea	ecx, DWORD PTR $T461677[esp+120]
	mov	DWORD PTR $T461677[esp+128], edx
	push	ecx
	lea	edx, DWORD PTR _bbox2$[esp+124]
	mov	DWORD PTR $T461677[esp+136], eax
	push	edx
	lea	eax, DWORD PTR $T461678[esp+128]
	push	eax
	call	DWORD PTR __imp__IntersectRect@12
	mov	eax, DWORD PTR _bbox$[ebp]
	mov	ecx, DWORD PTR $T461678[esp+120]
	mov	edx, DWORD PTR $T461678[esp+124]
	mov	DWORD PTR [eax], ecx
	mov	ecx, DWORD PTR $T461678[esp+128]
	mov	DWORD PTR [eax+4], edx
	mov	edx, DWORD PTR $T461678[esp+132]
	mov	DWORD PTR [eax+8], ecx
