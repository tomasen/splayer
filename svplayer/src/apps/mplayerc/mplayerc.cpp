...
#define ADDCMD(cmd) wmcmds.AddTail(wmcmd##cmd)
		...
		ADDCMD((ID_BRIGHTINC, VK_HOME, FVIRTKEY|FCONTROL|FNOINVERT, ResStr(IDS_HOTKEY_BRIGHT_MORE)));
		ADDCMD((ID_BRIGHTDEC, VK_END, FVIRTKEY|FCONTROL|FNOINVERT, ResStr(IDS_HOTKEY_BRIGHT_LESS)));
		...
		ADDCMD((ID_PLAY_PLAY, 0, FVIRTKEY|FNOINVERT, ResStr(IDS_HOTKEY_PLAY_PLAY)));
		ADDCMD((ID_PLAY_PAUSE, 0, FVIRTKEY|FNOINVERT, ResStr(IDS_HOTKEY_PLAY_PAUSE)));
		ADDCMD((ID_PLAY_STOP, VK_OEM_PERIOD, FVIRTKEY|FNOINVERT, ResStr(IDS_HOTKEY_PLAY_STOP), APPCOMMAND_MEDIA_STOP));
		...
		ADDCMD((ID_PLAY_SEEKFORWARDSMALL, 0, FVIRTKEY|FNOINVERT, ResStr(IDS_HOTKEY_SEEK_FORWARD_SMALL)));
		ADDCMD((ID_PLAY_SEEKBACKWARDSMALL, 0, FVIRTKEY|FNOINVERT, ResStr(IDS_HOTKEY_SEEK_BACKWARD_SMALL)));
		...
		ADDCMD((ID_VOLUME_UP, VK_UP, FVIRTKEY|FNOINVERT, ResStr(IDS_HOTKEY_VOLUME_UP), 0, wmcmd::WUP));//APPCOMMAND_VOLUME_UP
		ADDCMD((ID_VOLUME_DOWN, VK_DOWN, FVIRTKEY|FNOINVERT, ResStr(IDS_HOTKEY_VOLUME_DOWN), 0, wmcmd::WDOWN));//APPCOMMAND_VOLUME_DOWN
		ADDCMD((ID_VOLUME_MUTE, 'M', FVIRTKEY|FCONTROL|FNOINVERT, ResStr(IDS_HOTKEY_VOLUME_MUTE)));//, APPCOMMAND_VOLUME_MUTE
