...
extern "C" {
	...
	interface __declspec(uuid("EBE1FB08-3957-47ca-AF13-5827E5442E56")) IDirectVobSub : public IUnknown 
    {
	...
	interface __declspec(uuid("AB52FC9C-2415-4dca-BC1C-8DCC2EAE8150")) IDirectVobSub2 : public IDirectVobSub
	{
