...
; 36   : 	{
	...
	mov	eax, DWORD PTR _pLock$[esp-4]
...
; 129  : 		return m_file && m_file->m_segments.Lookup((float)rt/10000000, k) ? (POSITION)(++k) : NULL;
	...
	mov	eax, DWORD PTR [eax+20]
	test	eax, eax
	je	SHORT $LN3@GetStartPo@5
	fild	QWORD PTR _rt$[esp-4]
	push	esi
	lea	ecx, DWORD PTR _k$[esp]
	push	ecx
	fdiv	QWORD PTR __real@416312d000000000
	push	ecx
	lea	esi, DWORD PTR [eax+96]
	fstp	DWORD PTR tv144[esp+8]
	fld	DWORD PTR tv144[esp+8]
	fstp	DWORD PTR [esp]
...
;	COMDAT xdata$x
; File d:\-=svn=-\svplayer\src\subtitles\libssf\stream.cpp
xdata$x	SEGMENT
...
; 104  : 			m_file->Append(ssf::WCharInputStream(str), (float)rtStart / 10000000, (float)rtStop / 10000000);
	...
	mov	eax, DWORD PTR $T517439[ebp+40]
	add	eax, -16				; fffffff0H
	lea	edx, DWORD PTR [eax+12]
	or	ecx, -1
	lock	 xadd	 DWORD PTR [edx], ecx
	...
	call	eax
$LN29@Append@4:
	lea	esi, DWORD PTR $T517439[ebp+16]
	mov	DWORD PTR $T517439[ebp], OFFSET ??_7InputStream@ssf@@6B@
	call	?RemoveAll@?$CAtlList@HV?$CElementTraits@H@ATL@@@ATL@@QAEXXZ ; ATL::CAtlList<int,ATL::CElementTraits<int> >::RemoveAll
$LN10@Append@4:
...
; 52   : 			CString str = fn;
	...
	add	eax, 16					; 00000010H
	add	esp, 4
	mov	DWORD PTR _str$124986[ebp], eax

; 53   : 			str.Replace('\\', '/');

	push	47					; 0000002fH
	push	92					; 0000005cH
	lea	ecx, DWORD PTR _str$124986[ebp]
	mov	bl, 2
	push	ecx
	mov	BYTE PTR __$EHRec$[ebp+12], bl
...
; 54   : 			name = str.Left(str.ReverseFind('.'));
	...
	mov	esi, DWORD PTR _str$124986[ebp]
	push	46					; 0000002eH
	push	esi
	call	_wcsrchr
	add	esp, 8
...
; 61   : 			if(Open(FileInputStream(fn), name)) 
	...
	add	esp, 4
	mov	DWORD PTR [esi], eax
	lea	ecx, DWORD PTR $T517696[ebp]
	mov	BYTE PTR __$EHRec$[ebp+12], 7
	mov	edi, DWORD PTR _fn$[ebp]
	push	ecx
	...
	mov	BYTE PTR __$EHRec$[ebp+12], 6
	mov	bl, al
	mov	eax, DWORD PTR $T517696[ebp+40]
	mov	DWORD PTR $T517696[ebp], OFFSET ??_7FileInputStream@ssf@@6B@
	test	eax, eax
	je	SHORT $LN128@Open@2
	push	eax
	call	_fclose
	add	esp, 4
	mov	DWORD PTR $T517696[ebp+40], 0
$LN128@Open@2:
	lea	esi, DWORD PTR $T517696[ebp+16]
	mov	DWORD PTR $T517696[ebp], OFFSET ??_7InputStream@ssf@@6B@
	call	?RemoveAll@?$CAtlList@HV?$CElementTraits@H@ATL@@@ATL@@QAEXXZ ; ATL::CAtlList<int,ATL::CElementTraits<int> >::RemoveAll
	test	bl, bl
	je	SHORT $LN1@Open@2
...
; 237  : 		return !m_fn.IsEmpty() && Open(m_fn, m_name) ? S_OK : E_FAIL;
	...
	push	ecx
	sub	eax, 16					; 00000010H
	mov	DWORD PTR $T527190[esp+40], esp
	mov	edi, esp
	push	eax
	call	?CloneData@?$CSimpleStringT@_W$0A@@ATL@@CAPAUCStringData@2@PAU32@@Z ; ATL::CSimpleStringT<wchar_t,0>::CloneData
	add	eax, 16					; 00000010H
	...
	mov	eax, DWORD PTR [esi+4]
	sub	eax, 16					; 00000010H
	mov	DWORD PTR $T527191[esp+44], esp
	mov	edi, esp
	push	eax
	call	?CloneData@?$CSimpleStringT@_W$0A@@ATL@@CAPAUCStringData@2@PAU32@@Z ; ATL::CSimpleStringT<wchar_t,0>::CloneData
	add	esp, 4
...
; 171  : 		CAutoPtrList<Subtitle> subs;
	...
	mov	DWORD PTR _subs$[esp+120], edi
	mov	DWORD PTR _subs$[esp+124], edi
	mov	DWORD PTR _subs$[esp+128], edi
	mov	DWORD PTR _subs$[esp+132], edi
	mov	DWORD PTR _subs$[esp+136], edi
...
; 172  : 		m_file->Lookup((float)rt/10000000, subs);
	...
	lea	edi, DWORD PTR _subs$[esp+124]
	fstp	DWORD PTR tv420[esp+124]
	fld	DWORD PTR tv420[esp+124]
	fstp	DWORD PTR [esp]
	push	ecx
...
; 180  : 			const RenderedSubtitle* rs = m_renderer->Lookup(s, CSize(spd.w, spd.h), spd.vidrect);
	...
	push	ecx
	lea	edx, DWORD PTR $T527315[esp+124]
	push	edx
	call	DWORD PTR __imp__CopyRect@8
	mov	ecx, DWORD PTR [esi+8]
	mov	eax, DWORD PTR [esi+4]
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T527316[esp+124], ecx
	lea	ecx, DWORD PTR $T527315[esp+120]
	push	ecx
	mov	DWORD PTR $T527316[esp+124], eax
	mov	eax, DWORD PTR [edx+24]
	push	ebx
	push	eax
	lea	ecx, DWORD PTR $T527316[esp+132]
...
; 181  : 			if(rs) bbox2 |= rs->Draw(spd);
	...
	push	esi
	lea	edx, DWORD PTR $T527317[esp+124]
	push	edx
	push	eax
...
; 184  : 		bbox = bbox2 & CRect(0, 0, spd.w, spd.h);
	...
	xor	eax, eax
	mov	DWORD PTR $T527318[esp+120], eax
	mov	DWORD PTR $T527318[esp+124], eax
	mov	eax, DWORD PTR [esi+8]
	lea	ecx, DWORD PTR $T527318[esp+120]
	mov	DWORD PTR $T527318[esp+128], edx
	push	ecx
	lea	edx, DWORD PTR _bbox2$[esp+124]
	mov	DWORD PTR $T527318[esp+136], eax
	push	edx
	lea	eax, DWORD PTR $T527319[esp+128]
	push	eax
	call	DWORD PTR __imp__IntersectRect@12
	mov	eax, DWORD PTR _bbox$[ebp]
	mov	ecx, DWORD PTR $T527319[esp+120]
	mov	edx, DWORD PTR $T527319[esp+124]
	mov	DWORD PTR [eax], ecx
	mov	ecx, DWORD PTR $T527319[esp+128]
	mov	DWORD PTR [eax+4], edx
	mov	edx, DWORD PTR $T527319[esp+132]
	mov	DWORD PTR [eax+8], ecx
